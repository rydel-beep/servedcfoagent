...
(function() {
  ...
  function initKeyboardShortcuts() {
    ...
    document.addEventListener('keydown', function(e) {
      ...
      if (gPending) {
        gPending = false;
        var map = { c: 'section-cash-position', f: 'section-funnel', a: 'section-ad-tracking', b: 'section-brief', t: 'section-team', m: 'section-trend' };
  ...
  var ZONES = [
    ...
    { n: 2, title: 'Is the machine working', sub: 'MRR, unit economics, funnel, capacity',
      ids: ['section-kpis', 'section-revenue', 'section-month-perf', 'section-metrics',
            'section-funnel', 'section-ad-tracking', 'section-speed-to-lead', 'section-perf-analysis', 'section-setter-deep',
